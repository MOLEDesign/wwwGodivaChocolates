...
<!--<body style="background:url(images/stories/<?php echo($background);?>) top center no-repeat;"> -->
<body class="<?php echo $this->language; ?>">
	<!-- start godiva left template -->
				...
				<div id="content">
					<div class="wrapper">
						...
						<div id="content_scrollable" class="scroll-pane">
							<div class="block_right"><jdoc:include type="modules" name="block_right" style="none" /></div> 
