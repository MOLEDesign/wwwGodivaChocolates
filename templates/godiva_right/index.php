...
<!--<body style="background:url(images/stories/<?php echo($background);?>) top center no-repeat;" class="content_right">-->
<body class="content_right <?php echo $this->language; ?>">
	<!-- start godiva right template -->
	<!-- start wrapper -->
		<div id="wrapper">
