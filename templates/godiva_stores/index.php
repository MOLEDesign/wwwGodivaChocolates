...
<script type="text/javascript" src="<?php echo $this->baseurl ?>/scripts/stores.js"></script>
...
<!--<body style="background:url(images/stories/<?php echo($background);?>) top center no-repeat;" class="content_full stores">  -->
<body  class="content_full stores">
	<!-- start godiva stores template -->
					...
					<div class="wrapper">
							...
							<div class="content_right_container">
								...
								<?php
									if($_GET['Itemid'] != 69)
									{
										?><div class="submenu"><jdoc:include type="modules" name="submenu_stores" style="none" /><jdoc:include type="modules" name="submenu_stores_location" style="none" /></div><?
									}
                                ?>
